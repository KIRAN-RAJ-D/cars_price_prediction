...
with open(r"C:\Users\kiran\kiran.pkl", 'rb') as file:
    model = pickle.load(file)

# Path to the car photos directory
CAR_PHOTOS_DIR = r"C:\Users\kiran\car_photos"

# USD to INR exchange rate (example value, update as needed)
USD_TO_INR_EXCHANGE_RATE = 83.50
...
if st.button("Predict Price"):
    ...
    price_in_inr = prediction[0] * USD_TO_INR_EXCHANGE_RATE
    st.write(f"Predicted Price: ₹{price_in_inr:,.2f}")
